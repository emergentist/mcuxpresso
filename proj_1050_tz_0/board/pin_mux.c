...
pin_labels:
- {pin_num: G11, pin_signal: GPIO_AD_B0_03, label: D8/SDO, identifier: SDO}
- {pin_num: G13, pin_signal: GPIO_AD_B0_10, label: D5/SCLK, identifier: SCLK}
- {pin_num: G10, pin_signal: GPIO_AD_B0_11, label: D2/notDRDY, identifier: notDRDY}
- {pin_num: H13, pin_signal: GPIO_AD_B1_08, label: D3/MCLK, identifier: MCLK}
...
- pin_list:
  - {pin_num: H13, peripheral: PWM4, signal: 'A, 0', pin_signal: GPIO_AD_B1_08, direction: OUTPUT, pull_up_down_config: Pull_Up_22K_Ohm, speed: MHZ_50, slew_rate: Fast}
  - {pin_num: G13, peripheral: PWM1, signal: 'A, 3', pin_signal: GPIO_AD_B0_10, direction: OUTPUT, pull_up_down_config: Pull_Up_22K_Ohm, speed: MHZ_50}
  - {pin_num: G10, peripheral: GPIO1, signal: 'gpio_io, 11', pin_signal: GPIO_AD_B0_11, direction: INPUT, gpio_interrupt: kGPIO_IntFallingEdge, pull_up_down_config: Pull_Up_22K_Ohm,
    speed: MHZ_50, slew_rate: Fast}
  - {pin_num: G11, peripheral: GPIO1, signal: 'gpio_io, 03', pin_signal: GPIO_AD_B0_03, direction: INPUT, pull_up_down_config: Pull_Up_22K_Ohm, speed: MHZ_50, slew_rate: Fast}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of SDO on GPIO_AD_B0_03 (pin G11) */
  gpio_pin_config_t SDO_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_03 (pin G11) */
  GPIO_PinInit(GPIO1, 3U, &SDO_config);

  /* GPIO configuration of notDRDY on GPIO_AD_B0_11 (pin G10) */
  gpio_pin_config_t notDRDY_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_IntFallingEdge
  };
  /* Initialize GPIO functionality on GPIO_AD_B0_11 (pin G10) */
  GPIO_PinInit(GPIO1, 11U, &notDRDY_config);
  /* Enable GPIO pin interrupt on GPIO_AD_B0_11 (pin G10) */
  GPIO_PortEnableInterrupts(GPIO1, 1U << 11U);
  ...
  IOMUXC_SetPinConfig(
      ...
      0xD031U);                               /* Slew Rate Field: Fast Slew Rate
  ...
  IOMUXC_SetPinConfig(
      ...
      0xF021U);                               /* Slew Rate Field: Fast Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B1_08_FLEXPWM4_PWMA00,   /* GPIO_AD_B1_08 PAD functional properties : */
      0xD031U);                               /* Slew Rate Field: Fast Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: low(50MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
