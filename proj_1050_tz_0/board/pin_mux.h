...
/* GPIO_AD_B1_08 (coord H13), D3/MCLK */
#define BOARD_INITPINS_MCLK_PERIPHERAL                                      PWM4   /*!< Device name: PWM4 */
#define BOARD_INITPINS_MCLK_SIGNAL                                             A   /*!< PWM4 signal: A */
#define BOARD_INITPINS_MCLK_CHANNEL                                           0U   /*!< PWM4 A channel: 0 */
#define BOARD_INITPINS_MCLK_PIN_NAME                               GPIO_AD_B1_08   /*!< Pin name */
#define BOARD_INITPINS_MCLK_LABEL                                      "D3/MCLK"   /*!< Label */
#define BOARD_INITPINS_MCLK_NAME                                          "MCLK"   /*!< Identifier name */
#define BOARD_INITPINS_MCLK_DIRECTION                   kPIN_MUX_DirectionOutput   /*!< Direction */

/* GPIO_AD_B0_10 (coord G13), D5/SCLK */
...
#define BOARD_INITPINS_SCLK_PIN_NAME                               GPIO_AD_B0_10   /*!< Pin name */
#define BOARD_INITPINS_SCLK_LABEL                                      "D5/SCLK"   /*!< Label */
#define BOARD_INITPINS_SCLK_NAME                                          "SCLK"   /*!< Identifier name */
#define BOARD_INITPINS_SCLK_DIRECTION                   kPIN_MUX_DirectionOutput   /*!< Direction */

/* GPIO_AD_B0_11 (coord G10), D2/notDRDY */
#define BOARD_INITPINS_notDRDY_GPIO                                        GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_notDRDY_PORT                                        GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_notDRDY_GPIO_PIN                                      11U   /*!< GPIO1 pin index: 11 */
#define BOARD_INITPINS_notDRDY_PIN_NAME                            GPIO_AD_B0_11   /*!< Pin name */
#define BOARD_INITPINS_notDRDY_LABEL                                "D2/notDRDY"   /*!< Label */
#define BOARD_INITPINS_notDRDY_NAME                                    "notDRDY"   /*!< Identifier name */
#define BOARD_INITPINS_notDRDY_DIRECTION                 kPIN_MUX_DirectionInput   /*!< Direction */

/* GPIO_AD_B0_03 (coord G11), D8/SDO */
#define BOARD_INITPINS_SDO_GPIO                                            GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_SDO_PORT                                            GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_SDO_GPIO_PIN                                           3U   /*!< GPIO1 pin index: 3 */
#define BOARD_INITPINS_SDO_PIN_NAME                                GPIO_AD_B0_03   /*!< Pin name */
#define BOARD_INITPINS_SDO_LABEL                                        "D8/SDO"   /*!< Label */
#define BOARD_INITPINS_SDO_NAME                                            "SDO"   /*!< Identifier name */
#define BOARD_INITPINS_SDO_DIRECTION                     kPIN_MUX_DirectionInput   /*!< Direction */
...
/* GPIO_AD_B1_08 (coord H13), D3/MCLK */
#define BOARD_INITCSIPINS_MCLK_PERIPHERAL                                    CSI   /*!< Device name: CSI */
#define BOARD_INITCSIPINS_MCLK_SIGNAL                                   csi_data   /*!< CSI signal: csi_data */
#define BOARD_INITCSIPINS_MCLK_CHANNEL                                        9U   /*!< CSI csi_data channel: 09 */
#define BOARD_INITCSIPINS_MCLK_PIN_NAME                            GPIO_AD_B1_08   /*!< Pin name */
#define BOARD_INITCSIPINS_MCLK_LABEL                                   "D3/MCLK"   /*!< Label */
#define BOARD_INITCSIPINS_MCLK_NAME                                       "MCLK"   /*!< Identifier name */
